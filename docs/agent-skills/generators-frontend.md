---
outline: deep
title: "Agent Skill: Frontend Generator - LaraJS Docs"
description: "AI skill context for LaraJS frontend code generation: Vue.js CMS structure, API integration, router setup, hooks, LaraForm, LaraTable, and TypeScript models."
author: "LaraJS Team"
head:
  - - meta
    - name: robots
  ...
  - - meta
    - property: og:title
      content: "Agent Skill: Frontend Generator - LaraJS Docs"
  - - meta
    - property: og:url
...
````markdown
---
name: generators-frontend
description: Use when the user asks about LaraJS frontend code generation, generated Vue.js CMS structure, API integration files, router setup (constantRoutes vs asyncRoutes), Vue hooks (useForms, useTables), LaraForm component, LaraTable component, Vue views (Form.vue, index.vue), or TypeScript model interfaces generated by LaraJS.
---

# CMS Structure (Monorepo)

LaraJS generates the CMS according to the following structure:
