---
outline: deep
title: "Agent Skill: LaraJS i18n Package - LaraJS Docs"
description: "AI skill context for the LaraJS i18n package: converting Laravel PHP language files to JSON for Vue.js frontend internationalization."
author: "LaraJS Team"
head:
  - - meta
    - name: robots
