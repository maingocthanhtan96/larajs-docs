---
outline: deep
title: "Agent Skill: Generator Overview - LaraJS Docs"
description: "AI skill context for LaraJS generator overview: model configuration, field types, database types, relationships, and DBML import."
author: "LaraJS Team"
head:
  - - meta
    - name: robots
  ...
  - - meta
    - property: og:title
      content: "Agent Skill: Generator Overview - LaraJS Docs"
  - - meta
    - property: og:url
